...
void camera::moveCamerUp(float dir)
{
...
{
    return(vector3d(-cos(camPitch*M_PI/180)*sin(camYaw*M_PI/180),sin(camPitch*M_PI/180),-cos(camPitch*M_PI/180.0)*cos(camYaw*M_PI/180)));
}
